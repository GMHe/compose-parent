...
import cn.compose.alert.websocket.TableWebSocketHandler;
import cn.compose.alert.base.Response;
import cn.compose.alert.constant.Constants;
import cn.compose.alert.dao.AlertMapper;
import cn.compose.alert.dto.MessageVO;
...
//        return valueSet.stream().map(String::valueOf).alert(toList());
//    }
//
//    /**
//     * 组装 scan 的结果集
