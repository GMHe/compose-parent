...
//     */
//    public static InputStream convertLocaleFile(String filePath, String suffix) throws Exception {
...
//        OpenOfficeConnection connection = new SocketOpenOfficeConnection("10.66.96.73", OPENOFFICE_PORT);
//        connection.connect();
