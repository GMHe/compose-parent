...
-- ----------------------------
-- Table structure for code_history
-- ----------------------------
...
CREATE TABLE `flyway_schema_history` (
  ...
  `script` varchar(1000) DEFAULT NULL COMMENT 'script',
  `checksum` int(11) DEFAULT NULL COMMENT 'checksum',
  `installed_by` varchar(100) DEFAULT NULL COMMENT 'installed_by',
  `installed_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'installed_on',
  `execution_time` int(11) DEFAULT NULL COMMENT 'execution_time',
  `success` tinyint(1) DEFAULT NULL COMMENT 'success',
  PRIMARY KEY (`installed_rank`),
  KEY `flyway_schema_history_s_idx` (`success`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='flyway记录表';

-- ----------------------------
-- Records of flyway_schema_history
-- ----------------------------
BEGIN;
INSERT INTO `flyway_schema_history` VALUES (1, '1.1.0', 'init', 'SQL', 'V1.1.0__init.sql', 962455822, 'root', '2022-02-27 23:32:44', 80, 1);
INSERT INTO `flyway_schema_history` VALUES (2, '1.1.1', 'history', 'SQL', 'V1.1.1__history.sql', -161665376, 'root', '2022-02-27 23:32:45', 107, 1);
INSERT INTO `flyway_schema_history` VALUES (3, '1.1.2', 'addSourceTable', 'SQL', 'V1.1.2__addSourceTable.sql', -725969341, 'root', '2022-02-27 23:32:45', 48, 1);
INSERT INTO `flyway_schema_history` VALUES (4, '1.1.3', 'account', 'SQL', 'V1.1.3__account.sql', -221820761, 'root', '2022-02-27 23:32:45', 49, 1);
COMMIT;
...
INSERT INTO `order_info` VALUES (7, '534822234981126912', '109102489911033856', 1, 2, 1.01, '2022-04-15 19:53:15', 1.01, 1, NULL, '2022-04-15 19:53:16', NULL);
COMMIT;
...
INSERT INTO `prov_order` VALUES (30, '534406165237599744', '108686427428093952', 1, 1, 0, 1.01, NULL, 5, 'https://page-4gttfzlfpj4.zhifu.fm.it88168.com/pay?orderNo=108686427428093952', NULL, 1.01, NULL, '2022-04-14 16:19:19', NULL);
INSERT INTO `prov_order` VALUES (31, '534407756233575936', '108688012891783168', 1, 1, 0, 1.01, NULL, 5, 'https://page-4gttfzlfpj4.zhifu.fm.it88168.com/pay?orderNo=108688012891783168', NULL, 1.01, NULL, '2022-04-14 16:25:38', NULL);
INSERT INTO `prov_order` VALUES (32, '534408615617218048', '108688872174649344', 1, 1, 0, 1.01, NULL, 5, 'https://page-4gttfzlfpj4.zhifu.fm.it88168.com/pay?orderNo=108688872174649344', NULL, 1.01, NULL, '2022-04-14 16:29:03', NULL);
INSERT INTO `prov_order` VALUES (33, '534409560392518400', '108689817256198144', 1, 1, 0, 1.01, NULL, 5, 'https://page-4gttfzlfpj4.zhifu.fm.it88168.com/pay?orderNo=108689817256198144', NULL, 1.01, NULL, '2022-04-14 16:32:48', NULL);
INSERT INTO `prov_order` VALUES (34, '534821849264542464', '109102107503755264', 1, 1, 0, 1.01, NULL, 5, 'https://page-4gttfzlfpj4.zhifu.fm.it88168.com/pay?orderNo=109102107503755264', NULL, 1.01, NULL, '2022-04-15 19:51:05', NULL);
INSERT INTO `prov_order` VALUES (35, '534822234981126912', '109102489911033856', 1, 1, 2, 1.01, 1.01, 5, 'https://page-4gttfzlfpj4.zhifu.fm.it88168.com/pay?orderNo=109102489911033856', '2022-04-15 19:53:15', 1.01, NULL, '2022-04-15 19:52:37', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `source` VALUES (1, 1, 'compose-admin', 'admin服务消费', 1, 1, 'name', NULL, NULL, NULL, NULL, NULL);
COMMIT;
