...
import cn.compose.sync.biz.OrderBiz;
import cn.compose.sync.biz.PulshServiceImpl;
...
public class OrderRest {
    ...
    @Resource
    private PulshServiceImpl pulshService;
    ...
    public String kafkaPush() {
        ...
        mapList.add(map);
        pulshService.report(mapList,"compose-canal");
        return "ok";
    }
}
