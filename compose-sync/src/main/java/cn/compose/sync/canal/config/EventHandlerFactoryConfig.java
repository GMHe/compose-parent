package cn.compose.sync.canal.config;

import cn.compose.sync.canal.event.TableInfo;
import cn.compose.sync.canal.service.EventHandlerFactory;
import cn.compose.sync.canal.service.redis.RedisAddHandler;
import cn.compose.sync.canal.service.redis.RedisDeleteHandler;
import cn.compose.sync.canal.service.redis.RedisUpdateHandler;
